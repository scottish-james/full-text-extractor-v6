"""
PowerPoint Reading Order Extractor - Enhanced Debug Version
Fixed version with comprehensive debugging in semantic order method
"""
...
class AccessibilityOrderExtractorV2:
    """
    Extracts shapes in PowerPoint slides in the proper reading order
    """
    ...
    def get_slide_reading_order(self, slide, slide_number):
        ...
        # Get roles from the classifications stored during semantic ordering
        shapes_with_roles = []
    ...
    def _get_xml_document_order_deduplicated(self, slide):
        ...
        """
        # For now, return the original slide shapes
        # This is where you'd implement actual XML parsing if needed
